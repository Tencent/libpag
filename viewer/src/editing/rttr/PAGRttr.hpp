...
RTTR_REGISTRATION {
  ...
  registration::class_<pag::DisplacementMapEffect>("DisplacementMapEffect")
      .property_readonly("useForHorizontalDisplacement",
                         &pag::DisplacementMapEffect::useForHorizontalDisplacement)
      .property_readonly("maxHorizontalDisplacement",
                         &pag::DisplacementMapEffect::maxHorizontalDisplacement)
      .property_readonly("useForVerticalDisplacement",
                         &pag::DisplacementMapEffect::useForVerticalDisplacement)
      .property_readonly("maxVerticalDisplacement",
                         &pag::DisplacementMapEffect::maxVerticalDisplacement)
      .property_readonly("displacementMapBehavior",
                         &pag::DisplacementMapEffect::displacementMapBehavior)
  ...
  registration::enumeration<pag::LayerType>("LayerType")(
      value("Unknown", pag::LayerType::Unknown), value("Null", pag::LayerType::Null),
      value("Solid", pag::LayerType::Solid), value("Text", pag::LayerType::Text),
      value("Shape", pag::LayerType::Shape), value("Image", pag::LayerType::Image),
      value("PreCompose", pag::LayerType::PreCompose), value("Camera", pag::LayerType::Camera));

  registration::enumeration<pag::PAGScaleMode>("PAGScaleMode")(
      value("None", pag::PAGScaleMode::None), value("Stretch", pag::PAGScaleMode::Stretch),
      value("LetterBox", pag::PAGScaleMode::LetterBox), value("Zoom", pag::PAGScaleMode::Zoom));

  registration::enumeration<pag::PAGTimeStretchMode>("PAGTimeStretchMode")(
      value("None", pag::PAGTimeStretchMode::None), value("Scale", pag::PAGTimeStretchMode::Scale),
  ...
  registration::enumeration<pag::BlendMode>("BlendMode")(
      value("Normal", pag::BlendMode::Normal), value("Multiply", pag::BlendMode::Multiply),
      value("Screen", pag::BlendMode::Screen), value("Overlay", pag::BlendMode::Overlay),
      value("Darken", pag::BlendMode::Darken), value("Lighten", pag::BlendMode::Lighten),
      value("ColorDodge", pag::BlendMode::ColorDodge),
      value("ColorBurn", pag::BlendMode::ColorBurn), value("HardLight", pag::BlendMode::HardLight),
      value("SoftLight", pag::BlendMode::SoftLight),
      value("Difference", pag::BlendMode::Difference),
      value("Exclusion", pag::BlendMode::Exclusion), value("Hue", pag::BlendMode::Hue),
      value("Saturation", pag::BlendMode::Saturation), value("Color", pag::BlendMode::Color),
      value("Luminosity", pag::BlendMode::Luminosity), value("Add", pag::BlendMode::Add));

  registration::enumeration<pag::TagCode>("TagCode")(
      value("End", pag::TagCode::End), value("FontTables", pag::TagCode::FontTables),
      ...
      value("SolidColor", pag::TagCode::SolidColor), value("TextSource", pag::TagCode::TextSource),
      ...
      value("Transform2D", pag::TagCode::Transform2D), value("MaskBlock", pag::TagCode::MaskBlock),
      value("ShapeGroup", pag::TagCode::ShapeGroup), value("Rectangle", pag::TagCode::Rectangle),
      value("Ellipse", pag::TagCode::Ellipse), value("PolyStar", pag::TagCode::PolyStar),
      value("ShapePath", pag::TagCode::ShapePath), value("Fill", pag::TagCode::Fill),
      value("Stroke", pag::TagCode::Stroke), value("GradientFill", pag::TagCode::GradientFill),
      value("GradientStroke", pag::TagCode::GradientStroke),
      value("MergePaths", pag::TagCode::MergePaths), value("TrimPaths", pag::TagCode::TrimPaths),
      value("Repeater", pag::TagCode::Repeater), value("RoundCorners", pag::TagCode::RoundCorners),
      ...
      value("TextAnimatorPropertiesTrackingAmount",
            pag::TagCode::TextAnimatorPropertiesTrackingAmount),
      ...
      value("ImageScaleModes", pag::TagCode::ImageScaleModes), value("Count", pag::TagCode::Count));

  registration::enumeration<pag::PathDataVerb>("PathDataVerb")(
      value("MoveTo", pag::PathDataVerb::MoveTo), value("LineTo", pag::PathDataVerb::LineTo),
      value("CurveTo", pag::PathDataVerb::CurveTo), value("Close", pag::PathDataVerb::Close));
  ...
  registration::enumeration<pag::MaskMode>("MaskMode")(
      value("None", pag::MaskMode::None), value("Add", pag::MaskMode::Add),
      value("Subtract", pag::MaskMode::Subtract), value("Intersect", pag::MaskMode::Intersect),
      value("Lighten", pag::MaskMode::Lighten), value("Darken", pag::MaskMode::Darken),
      value("Difference", pag::MaskMode::Difference), value("Accum", pag::MaskMode::Accum));

  registration::enumeration<pag::EffectType>("EffectType")(
      value("Unknown", pag::EffectType::Unknown), value("Fill", pag::EffectType::Fill),
      value("MotionTile", pag::EffectType::MotionTile),
      value("LevelsIndividual", pag::EffectType::LevelsIndividual),
      value("CornerPin", pag::EffectType::CornerPin), value("Bulge", pag::EffectType::Bulge),
      value("FastBlur", pag::EffectType::FastBlur), value("Glow", pag::EffectType::Glow),
      value("DisplacementMap", pag::EffectType::DisplacementMap),
      value("RadialBlur", pag::EffectType::RadialBlur), value("Mosaic", pag::EffectType::Mosaic),
  ...
  registration::enumeration<pag::RadialBlurMode>("RadialBlurMode")(
      value("Spin", pag::RadialBlurMode::Spin), value("Zoom", pag::RadialBlurMode::Zoom));

  registration::enumeration<pag::RadialBlurAntialias>("RadialBlurAntialias")(
      value("Low", pag::RadialBlurAntialias::Low), value("High", pag::RadialBlurAntialias::High));
  ...
  registration::enumeration<pag::LayerStylePosition>("LayerStylePosition")(
      value("Above", pag::LayerStylePosition::Above), value("Blow", pag::LayerStylePosition::Blow));

  registration::enumeration<pag::StrokePosition>("StrokePosition")(
      value("Outside", pag::StrokePosition::Outside), value("Inside", pag::StrokePosition::Inside),
      value("Center", pag::StrokePosition::Center), value("Invalid", pag::StrokePosition::Invalid));
  ...
  registration::enumeration<pag::LineCap>("LineCap")(value("Butt", pag::LineCap::Butt),
                                                     value("Round", pag::LineCap::Round),
                                                     value("Square", pag::LineCap::Square));

  registration::enumeration<pag::LineJoin>("LineJoin")(value("Miter", pag::LineJoin::Miter),
  ...
  registration::enumeration<pag::GradientFillType>("GradientFillType")(
      ...
      value("Radial", pag::GradientFillType::Radial), value("Angle", pag::GradientFillType::Angle),
  ...
  registration::enumeration<pag::AnchorPointGrouping>("AnchorPointGrouping")(
      ...
      value("Word", pag::AnchorPointGrouping::Word), value("Line", pag::AnchorPointGrouping::Line),
  ...
  registration::enumeration<pag::TextSelectorMode>("TextSelectorMode")(
      value("None", pag::TextSelectorMode::None), value("Add", pag::TextSelectorMode::Add),
      value("Subtract", pag::TextSelectorMode::Subtract),
      value("Intersect", pag::TextSelectorMode::Intersect),
      value("Min", pag::TextSelectorMode::Min), value("Max", pag::TextSelectorMode::Max),
  ...
  registration::enumeration<pag::TextSelectorType>("TextSelectorType")(
      value("Range", pag::TextSelectorType::Range), value("Wiggly", pag::TextSelectorType::Wiggly),
      value("Expression", pag::TextSelectorType::Expression));

  registration::enumeration<pag::ShapeType>("ShapeType")(
      value("Unknown", pag::ShapeType::Unknown), value("ShapeGroup", pag::ShapeType::ShapeGroup),
      value("Rectangle", pag::ShapeType::Rectangle), value("Ellipse", pag::ShapeType::Ellipse),
      value("PolyStar", pag::ShapeType::PolyStar), value("ShapePath", pag::ShapeType::ShapePath),
      value("Fill", pag::ShapeType::Fill), value("Stroke", pag::ShapeType::Stroke),
      ...
      value("TrimPaths", pag::ShapeType::TrimPaths), value("Repeater", pag::ShapeType::Repeater),
      value("RoundCorners", pag::ShapeType::RoundCorners));

  registration::enumeration<pag::PolyStarType>("PolyStarType")(
      value("Star", pag::PolyStarType::Star), value("Polygon", pag::PolyStarType::Polygon));
  ...
  registration::enumeration<pag::MergePathsMode>("MergePathsMode")(
      value("Merge", pag::MergePathsMode::Merge), value("Add", pag::MergePathsMode::Add),
  ...
  registration::enumeration<pag::RepeaterOrder>("RepeaterOrder")(
      value("Below", pag::RepeaterOrder::Below), value("Above", pag::RepeaterOrder::Above));

  registration::enumeration<pag::IrisShapeType>("IrisShapeType")(
      value("FastRectangle", pag::IrisShapeType::FastRectangle),
      value("Triangle", pag::IrisShapeType::Triangle), value("Square", pag::IrisShapeType::Square),
      ...
      value("Octagon", pag::IrisShapeType::Octagon), value("Nonagon", pag::IrisShapeType::Nonagon),
      value("Decagon", pag::IrisShapeType::Decagon));

  registration::enumeration<pag::TrackMatteType>("TrackMatteType")(
      value("None", pag::TrackMatteType::None), value("Alpha", pag::TrackMatteType::Alpha),
  ...
  registration::enumeration<pag::CachePolicy>("CachePolicy")(
      value("Auto", pag::CachePolicy::Auto), value("Enable", pag::CachePolicy::Enable),
  ...
  registration::enumeration<pag::CompositionType>("CompositionType")(
      ...
      value("Vector", pag::CompositionType::Vector), value("Bitmap", pag::CompositionType::Bitmap),
