...
Item {
    ...
    //
    //     onDataChange: {
    //         currentFrameText = (runtimeModel.currentFrame + 1) + qsTr("/") + runtimeModel.totalFrame;
    //     }
    // }
    ...
    //         let spaceY = 0.1;
    //         let chartModel = runtimeModel.chartModel;
    ...
    // }
    //
    // function getHeight(value, max, height) {
    //     let r = value / max * height;
    //     let minHeight = 0.5;
    //     if (r < minHeight) {
    //         r = minHeight;
    //     }
