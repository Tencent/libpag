...
/**
 * Indicates whether or not automatically downloading updates is allowed to be turned on by the
 * user. If this value is nil, the developer has not explicitly specified this option.
 */
