 ...
 */
- (NSArray<NSDictionary<NSString*, NSString*>*>*)feedParametersForUpdater:(SUUpdater*)updater
...
/*!
 ...
 \param updater The SUUpdater instance.
 \param item The appcast item corresponding to the update that is proposed to be installed.
 \param invocation The invocation that must be completed with `[invocation invoke]` before
 continuing with the relaunch.
...
/*!
 ...
 SUUpdaterDelegate::updater:shouldPostponeRelaunchForUpdate:untilInvoking: avoiding usage of
 NSInvocation, which is not available in Swift environments.
...
/*!
 ...
 SUUpdaterDelegate::updater:willInstallUpdateOnQuit:immediateInstallationInvocation: using a block
 instead of NSInvocation, which is not available in Swift environments. \param updater The SUUpdater
 instance. \param item The appcast item corresponding to the update that is proposed to be
 installed. \param installationBlock Can be used to trigger an immediate silent install and
 relaunch.
 */
- (void)updater:(SUUpdater*)updater
       willInstallUpdateOnQuit:(SUAppcastItem*)item
...
/*!
 ...
 \param item The appcast item corresponding to the update that was proposed to be installed.
  ...
  \deprecated This method is no longer invoked. The installer will try to its best ability to
 install the update.
 */
