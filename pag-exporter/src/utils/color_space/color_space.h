...
typedef void (xx_csp_convert_f)(uint8_t* dst[], int dst_stride[],
...
void
xx_nv21_to_i420_c(uint8_t* dst[], int dst_stride[], uint8_t* src[], int src_stride[], int width, int height, int vflip);
