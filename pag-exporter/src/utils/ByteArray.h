...
/**
 * The ByteArray class provides methods and properties to optimize reading and working with binary data. The
 * ByteArray object does not take ownership of the of the the binary data, The caller must keep the data alive
 * until the ByteArray object is done with it.
 * Note: The byte order of ByteArray is always big-endian.
 */
