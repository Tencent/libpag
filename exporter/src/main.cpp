...
extern "C" DllExport A_Err EntryPointFunc(struct SPBasicSuite* suite,
                                          [[maybe_unused]] A_long majorVersion,
                                          [[maybe_unused]] A_long minorVersion,
                                          AEGP_PluginID pluginID,
                                          [[maybe_unused]] AEGP_GlobalRefcon* globalRefcon) {
