...
class PAGXDocument : public Node {
 public:
   ...
   *
   * Content nodes (Image, SolidColor, Gradient, ColorStop, Fill, Stroke, Group, filters, styles,
   * etc.) are also accepted — the scene refreshes the Layer that contains the content node. You may
   * still pass the Layer directly; both are equivalent.
   *
