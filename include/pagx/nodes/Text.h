...
class Text : public Element, public LayoutNode {
 public:
  ...
  /**
   * Specifies how position.y is interpreted. VisualTop (default): position.y is the top of the
   * visual pixel bounds. Alphabetic: position.y is the alphabetic baseline.
   */
  TextBaseline baseline = TextBaseline::VisualTop;
  ...
  /**
   * Returns the per-glyph anchor offsets generated by TextLayout.
   */
