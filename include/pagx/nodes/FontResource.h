...
/**
 * Resolved font resource returned by ResourceLoader. It can either wrap raw font bytes
 * (ttf/otf/ttc) or a custom FontProvider supplied by business code. Importer consumes the resource
 * during document loading; loader owns any cache needed to keep shared data alive.
 */
class FontResource : public Resource {
 public:
  /**
   * Creates a FontResource by copying raw font bytes.
   * @param bytes pointer to font bytes. Must not be null unless length is zero.
  ...
  /**
   * Creates a FontResource from an existing immutable Data object.
   */
