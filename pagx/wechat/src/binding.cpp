...
EMSCRIPTEN_BINDINGS(PAGXView) {
  class_<PAGXView>("PAGXView")
      ...
      .function("attachNativeImage", &PAGXView::attachNativeImage)
      .function("setTextureEventHandler", &PAGXView::setTextureEventHandler)
      .function("isFullBudgetSaturated", &PAGXView::isFullBudgetSaturated)
      ...
      .function("setSnapshotEnabled", &PAGXView::setSnapshotEnabled)
