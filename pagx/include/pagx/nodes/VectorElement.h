...
/**
 * VectorElementType enumerates all types of vector elements that can be placed in Layer.contents
 * or Group.elements.
 */
...
/**
 * Returns the string name of a vector element type.
 */
 ...
 * (Rectangle, Ellipse, Polystar, Path, TextSpan), painters (Fill, Stroke), modifiers (TrimPath,
 * RoundCorner, MergePath), text elements (TextModifier, TextPath, TextLayout), and containers
 * (Group, Repeater).
 */
class VectorElement : public Node {
 public:
  /**
   * Returns the vector element type of this element.
   */
  virtual VectorElementType vectorElementType() const = 0;
