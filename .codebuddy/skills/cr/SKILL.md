...
Use the verifier's verdict as input, not as a final decision. Do not default to
either side — the reviewer's report and the verifier's rebuttal are equally weighted
inputs:
