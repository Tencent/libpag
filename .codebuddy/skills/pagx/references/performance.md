...
This file contains detailed examples for performance optimizations and resource reuse patterns.
...
rules, and detailed examples, see **Scenario C** in `structure-simplification.md`.
...
significantly. See **Replace Path with Primitive Geometry** below for conversion
