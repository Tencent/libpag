...
description: >-
  ...
  align, distribute, export), or look up PAGX element attributes and syntax.
---
...
| `cli.md` | CLI commands — `render`, `validate`, `optimize`, `format`, `bounds`, `font info`, `font embed`, `align`, `distribute`, `export` |
