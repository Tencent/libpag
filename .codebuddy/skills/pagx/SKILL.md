...
description: >-
  ...
  post) — static or animated — to a PAGX file. Captured motion (CSS @keyframes,
...
a public URL to convert, or is a non-developer who should not be asked PAGX-specific questions.
