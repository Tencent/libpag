...
namespace pag {
const std::string TestConstants::PAG_ROOT = "../";
const std::string TestConstants::BASELINE_ROOT = TestConstants::PAG_ROOT + "test/baseline/";
...
const std::string TestConstants::OUT_ROOT = TestConstants::PAG_ROOT + "test/out/";
...
const std::string TestConstants::DEFAULT_PAG_PATH = PAG_ROOT + "resources/apitest/test.pag";
}  // namespace pag