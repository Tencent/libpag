...
PAG_TEST_F(PAGTextLayerTest, Emoji_ID79762747) {
  auto pagFile = LoadPAGAsset("zongyi2.pag");
...
PAG_TEST_F(PAGTextLayerTest, NormalEmoji) {
  auto pagFile = LoadPAGAsset("test2.pag");
  auto textData = pagFile->getTextData(0);
  textData->text = "ha ha哈哈\n哈😆哈哈哈";
  pagFile->replaceText(0, textData);
  TestPAGPlayer->setComposition(pagFile);
...
PAG_TEST_F(PAGTextLayerTest, VerticalText_ID80511765) {
  auto pagFile = LoadPAGAsset("TextDirection.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->setProgress(0);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TrackingAnimator_ID859317799) {
  auto pagFile = LoadPAGAsset("TrackingAnimator.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->setProgress(0);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TrackingAnimatorVertical_ID859317799) {
  auto pagFile = LoadPAGAsset("TrackingAnimatorVertical.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->setProgress(0);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, PositionAnimator) {
  auto pagFile = LoadPAGAsset("TextPositionAnimator.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->setProgress(0);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TextAnimators_ID863204853) {
  auto pagFile = LoadPAGAsset("TextAnimators.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->setProgress(0);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TextAnimatorsMode_ID863204817) {
  auto pagFile = LoadPAGAsset("TextAnimatorMode.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->setProgress(0);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TextAnimatorsX7_ID863204817) {
  auto pagFile = LoadPAGAsset("TextAnimatorX7.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->setProgress(0);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TextAnimatorSmooth_ID863204817) {
  auto pagFile = LoadPAGAsset("TextAnimatorSmooth.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->setProgress(0);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TrackMatteTextBounds) {
  auto pagFile = LoadPAGAsset("text_matte.pag");
  TestPAGPlayer->setComposition(pagFile);
...
PAG_TEST_F(PAGTextLayerTest, SmallFontSizeScale) {
  auto pagFile = LoadPAGAsset("tougao.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TextPathCommon) {
  auto pagFile = LoadPAGAsset("TextPathCommon.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TextPathReversePath) {
  auto pagFile = LoadPAGAsset("TextPathReversed.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TextPathNotPerpendicular) {
  auto pagFile = LoadPAGAsset("TextPathNotPerpendicular.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TextPathForceAlignment) {
  auto pagFile = LoadPAGAsset("TextPathForceAlignment.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TextPathForceAlignment2) {
  auto pagFile = LoadPAGAsset("TextPathForceAlignment2.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TextPathClosedPath) {
  auto pagFile = LoadPAGAsset("TextPathClosedPath.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TextPathBox) {
  auto pagFile = LoadPAGAsset("TextPathBox.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TextPathBox2) {
  auto pagFile = LoadPAGAsset("TextPathBox2.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TextPathBoxReversed) {
  auto pagFile = LoadPAGAsset("TextPathBoxReversed.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TextRangeSelectorTriangleEarseHighAndLow) {
  auto pagFile = LoadPAGAsset("RangeSelectorTriangleHighLow.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->flush();
...
PAG_TEST_F(PAGTextLayerTest, TextLayerScaleAnimationWithMipmap) {
  auto pagFile = LoadPAGFile("apitest/text_layer_scale_mipmap.pag");
  TestPAGPlayer->setComposition(pagFile);
  TestPAGPlayer->setProgress(0.5f);
  TestPAGPlayer->flush();
  EXPECT_TRUE(
