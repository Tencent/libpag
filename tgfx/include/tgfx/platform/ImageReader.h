 ...
 * of the native platform. The video-related object could be a SurfaceTexture on the android
 * platform or an HTMLVideoElement on the web platform. ImageReader is an abstract class. Use its
