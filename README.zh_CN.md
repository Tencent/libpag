...
main 是主要的开发分支，日常会有频繁的修改合入。
release/{version} 是发布分支，我们会不定期基于main分支拉取，发布分支不会合入新功能，只修改缺陷和crash，是我们推荐的在生产环境中使用的稳定分支。

**注：这个仓库目前只包含最新的 PAG 4.0 版本代码。受开源协议的影响，该仓库不包含PAG 3.0 版本代码。**
