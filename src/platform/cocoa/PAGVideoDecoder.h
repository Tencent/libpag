 ...
 * async thread, and then switches to the hardware decoder when it is initialized. The default is
 * true, which will improve the performance of first frame rendering.
 */
