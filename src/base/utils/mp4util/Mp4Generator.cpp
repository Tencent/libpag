...
int32_t Mp4Generator::GetNowTime() {
  return Utils::getCurrentTimeMillis() / 1000;
}

void Mp4Generator::Clear() { BoxSizeMap.clear(); }

void Mp4Generator::InitParam(BoxParam &boxParam) { param.copy(boxParam); }
}
